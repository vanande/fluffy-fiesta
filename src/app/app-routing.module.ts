...
const routes: Routes = [
    ...
    { path: 'activitées', data: { breadcrumb: 'Activités' }, loadChildren: () => import('./demo/components/activities/activitylist/activitylist.module').then(m => m.ActivitylistModule) },
    { path: 'activitées/:id', data: { breadcrumb: 'Activités' }, loadChildren: () => import('./demo/components/activities/activity-overview/activity-overview.module').then(m => m.ActivityOverviewModule) },

    {
        ...
        children: [
            ...
            { path: 'ecommerce', data: { breadcrumb: 'E-Commerce' }, loadChildren: () => import('./demo/components/payment/ecommerce.module').then(m => m.EcommerceModule) },
